...
namespace Tutorial8_GlossMap
{
    ...
    public class ShaderTutorial : Microsoft.Xna.Framework.Game
    {
        ...
        {
            Window.Title = "Dark Codex Studios :: Shader programming, Tutorial 8";
        ...
        protected override void LoadContent()
        {
            ...
            glossMap = Content.Load<Texture2D>("glossmap");
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            objectMatrix = Matrix.CreateRotationX(90) * Matrix.CreateRotationY(-moveObject / 2);
            renderMatrix = Matrix.CreateScale(1.5f);
