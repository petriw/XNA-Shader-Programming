...
namespace Tutorial12_PostProcess
{
    /// <summary>
    ...
    public class ShaderTutorial : Microsoft.Xna.Framework.Game
    {
        ...
        {
            Window.Title = "Shader programming :: Tutorial 12 - Post process";
            ...
            spriteBatch.Begin(SpriteBlendMode.None, SpriteSortMode.Immediate, SaveStateMode.SaveState);
            {
                ...
                effectPost.Begin();
                {
                    effectPost.CurrentTechnique.Passes[0].Begin();
                    {
                        ...
                        effectPost.Parameters["iSeed"].SetValue(1337);
                        effectPost.Parameters["fNoiseAmount"].SetValue(0.01f);
