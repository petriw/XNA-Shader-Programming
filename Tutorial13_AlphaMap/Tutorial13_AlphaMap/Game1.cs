...
namespace Tutorial13_AlphaMap
{
    ...
    public class ShaderTutorial : Microsoft.Xna.Framework.Game
    {
        ...
        {
            Window.Title = "Shader programming :: Tutorial 13 - AlphaMapping";
        ...
        protected override void Initialize()
        {
            ...
            m_AlphaMap = Content.Load<Texture2D>("AlphaMap");
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            renderMatrix = Matrix.CreateScale(0.9f);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            foreach (EffectPass pass in effect.CurrentTechnique.Passes)
            {
                ...
                foreach (ModelMesh mesh in m_Model.Meshes)
                {
                    foreach (ModelMeshPart part in mesh.MeshParts)
                    {
                        ...
                        effect.Parameters["AlphaMap"].SetValue(m_AlphaMap);
            ...
            // Render the scene with a post process shader, using the render target from last frame.
