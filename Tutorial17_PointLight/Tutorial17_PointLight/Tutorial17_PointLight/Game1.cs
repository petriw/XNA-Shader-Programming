...
namespace Tutorial4_NormalMapping
{
    ...
    public class ShaderTutorial : Microsoft.Xna.Framework.Game
    {
        ...
        {
            Window.Title = "Dark Codex Studios :: Shader programming, Tutorial 17";
        ...
        protected override void LoadContent()
        {
            ...
            m_Model = Content.Load<Model>("abstract2");
            m_BGModel = Content.Load<Model>("ObjectMeteor");
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            renderMatrix = Matrix.CreateScale(0.2f);
            ...
            foreach (EffectPass pass in effect.CurrentTechnique.Passes)
            {
                ...
                foreach (ModelMesh mesh in m_Model.Meshes)
                {
                    foreach (ModelMeshPart part in mesh.MeshParts)
                    {
                        ...
                        Vector3 vLightPosition = new Vector3(70.0f, 0.0f, 0.0f);
                        Vector4 vLightColor = new Vector4(0.5f, 0.4f, 0.95f, 1.0f);
                        ...
                        // Set the light range and color of our point light
                        effect.Parameters["LightRange"].SetValue(1000.0f);
