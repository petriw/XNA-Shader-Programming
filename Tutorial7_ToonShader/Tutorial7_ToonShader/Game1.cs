...
namespace Tutorial7_ToonShader
{
    /// <summary>
    ...
    public class ShaderTutorial : Microsoft.Xna.Framework.Game
    {
        ...
        {
            Window.Title = "Shader programming :: Tutorial 7 - Toon Shader";
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.Begin(SpriteBlendMode.None, SpriteSortMode.Immediate, SaveStateMode.SaveState);
            {
                ...
                effectPostOutline.Begin();
                {
                    ...
                    {
                        effectPostOutline.Parameters["Thickness"].SetValue(1.0f);
                        effectPostOutline.Parameters["Threshold"].SetValue(0.2f);
