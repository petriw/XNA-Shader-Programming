...
namespace BlurExample
{
    ...
    public class ShaderTutorial : Microsoft.Xna.Framework.Game
    {
        ...
        {
            Window.Title = "XNA Shader Programming Tutorial 23 - Blur postprocess";
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            objectMatrix = Matrix.CreateRotationZ((float)Math.PI/2) * Matrix.CreateRotationY(-moveObject / 4);
